...
| `src/utils/` | Reusable, testable Python utility functions extracted from notebooks |
...
| `src/utils/descriptive_stats_funtions.py` | `load_data(filename)` — loads a CSV from `data/raw/` into a DataFrame |
